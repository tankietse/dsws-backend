...
public class SecurityConfig {
    private final NguoiDungService userService; // Tiêm UserService vào lớp cấu hình này.

    @Bean // Đánh dấu phương thức trả về một bean được quản lý bởi Spring Context.
    public UserDetailsService userDetailsService() {
//        return new NguoiDungService(); // Cung cấp dịch vụ xử lý chi tiết người dùng.
        return userService;
    }
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/index", "/images/**", "/css/**", "/js/**", "**.js", "/", "/oauth/**", "/register", "/error", "/cart", "/cart/**", "/home/**", "/login/**", "/logout/**")
                ...
                .formLogin(formLogin -> formLogin
                        ...
                        .defaultSuccessUrl("/index", true) // Trang sau đăng nhập thành công.
...
//        return http
//                .authorizeHttpRequests(auth -> auth
//                        .requestMatchers("/images/**", "/css/**", "/js/**", "/", "/login/**", "/logout/**", "/register").permitAll()
//                        .requestMatchers("/index").hasAnyAuthority("USER", "ADMIN") // Cho phép USER hoặc ADMIN truy cập
...
//                )
//                .exceptionHandling(exceptionHandling -> exceptionHandling
//                        .accessDeniedPage("/403") // Trang khi truy cập bị từ chối
//                )
//                .build();
//    }
}
